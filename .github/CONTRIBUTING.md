...
The [issue tracker][2] is
the preferred channel for [bug reports][3], [features requests][4]
and [submitting pull requests][5], but please respect the following
restrictions:

* Please **do not** use the issue tracker for personal support requests (use
  [Stack Overflow][6] or IRC).
...
3. **Isolate the problem** &mdash; ideally, create a [reduced test case][7] and a live example.
...
1. [Fork][8] the project, clone your
   ...
   git remote add upstream https://github.com/teocci/nginx-config
   ```
...
4. Commit your changes in logical chunks. Please adhere to these [git commit message guidelines][9]
...
7. [Open a Pull Request][11]
   with a clear title and description.

**IMPORTANT**: By submitting a patch, you agree to allow the project
owners to license your work under the terms of the [MIT License][12].

[1]: https://github.com/teocci/nginx-configs
[2]: https://github.com/teocci/nginx-configs/issues
[3]: #bugs
[4]: #features
[5]: #pull-requests
[6]: https://stackoverflow.com
[7]: https://css-tricks.com/reduced-test-cases
[8]: https://help.github.com/en/github/getting-started-with-github/fork-a-repo
